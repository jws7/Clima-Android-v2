...
public class WeatherController extends AppCompatActivity {
    ...
    private final String LOGCAT_TAG = "Clima";
    ...
    private void getWeatherForCurrentLocation() {
        Log.d(LOGCAT_TAG, "getWeatherForCurrentLocation() called!!!!");
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            ActivityCompat.requestPermissions(WeatherController.this, permissions, REQUEST_CODE);
        ...
        Log.d(LOGCAT_TAG, "Provider is enabled:" + mLocationManager.isProviderEnabled(LOCATION_PROVIDER));
        Log.d(LOGCAT_TAG, "Last location (if any)" + lastLocation);
        Log.d(LOGCAT_TAG, "Provider name:" + mLocationManager.getProvider(LOCATION_PROVIDER).getName());
        ...
        mLocationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                Log.d(LOGCAT_TAG, "onLocationChanged() longitude is: " + longitude );
                Log.d(LOGCAT_TAG, "onLocationChanged() latitude is: " + latitude );
            ...
            public void onStatusChanged(String s, int i, Bundle bundle) {
                Log.d(LOGCAT_TAG, "onStatusChanged() callback received");
                Log.d(LOGCAT_TAG, "2 means AVAILABLE, 1: TEMP_UNAVAILABLE, 0: OUT_OF_SERVICE");
            }
    ...
    private void letsDoSomeNetworking(RequestParams params){
        Log.d(LOGCAT_TAG, "letsDoSomeNetworking() reached");
        ...
        client.get(WEATHER_URL, params, new JsonHttpResponseHandler(){
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response){
                Log.d(LOGCAT_TAG, "onSuccess() reached. JSON:" + response.toString());
                updateUI(WeatherDataModel.fromJson(response));
            }

            @Override
            public void onFailure(int statusCode, Header[] headers, Throwable e, JSONObject response){
                Log.d(LOGCAT_TAG, "onFailure() reached. Failed: " + e.toString());

                Log.d(LOGCAT_TAG, "StatusCode: " + statusCode);
